...
public class CollectionObject2 extends Fragment {

    ListView list;
    Button btn;
    public static final String GET_IMAGE_URL="http://redesignedfashion.esy.es/getparty.php";

    public GetAllImages getAlImages;

    public static final String BITMAP_ID = "image";

    public CollectionObject2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_collection_object2, container, false);
        list=(ListView)v.findViewById(R.id.lvParty);
        //getUrls();
        return v;
    }

    public void btnClickPartyDisp(){
        getUrls();
    }
